...
Este programa fará a verificação se todos os pacotes necessários para o funcionamento do i3geo foram instalados e se os caminhos definidos no <i>ms_configura.php</i> estão corretos. Além destas verificações listadas acima, o programa <i>testainstal.php</i> verifica se o apache consegue escrever na pasta temporária e testa os mapfiles <i>geral1.map</i> e <i>estadosl.map</i>.
